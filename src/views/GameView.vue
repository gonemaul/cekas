    ...
    <div v-if="!isFinished" class="space-y-4">
      ...
      >
        <div v-if="route.query.method" class="mb-4 flex justify-center">
          <div
            class="inline-flex items-center gap-2 bg-amber-50 text-amber-700 text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-widest border border-amber-100 shadow-sm"
          >
        ...
        <div
          class="flex justify-between items-center mb-6 text-sm font-black uppercase tracking-tighter"
        >
          <span class="text-slate-400"
            >SOAL : <span class="text-slate-800">{{ currentStep }}</span
            >/10</span
          >
        ...
        <div class="relative">
          <input
            ...
            inputmode="numeric"
            :class="[
              'w-full text-center text-5xl p-6 bg-slate-50 border-2 border-slate-100 rounded-[2rem] focus:bg-white  outline-none transition-all font-black text-slate-800',
              isWrong
